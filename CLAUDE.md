...
> Note: `layout.tsx` currently calls `getProducts()` for debug purposes and logs the result to the terminal — this is intentional dev scaffolding, not production behaviour.
